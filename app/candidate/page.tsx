...
export default function Candidate(){
 ...
 return <div className="wrap"><nav className="nav"><Link className="brand" href="/candidate">Career<span>Verify</span></Link><div className="links"><Link className="btn alt" href="/profile">Profile</Link><Link className="btn alt" href="/verify">Verification</Link></div></nav><div className="card"><div className="pill">EMPLOYEE WORKSPACE</div><h1>Your Career ID</h1><div className="stat">{careerId||"Loading…"}</div><p className="muted">Share this ID when an employer needs to initiate verification. Private records remain protected.</p></div>
 <section className="section"><div className="card"><div className="pill">CAREER PROFILE</div><h2>Complete your profile</h2><p className="muted">Keep your basic account details updated. Employment history is added through verified employer records.</p><Link className="btn" href="/profile">Open profile</Link></div></section>
